<script lang="ts">
	...
	let columns = [
		...
		{ data: 'ICDO_localizationCode', header: $t("localizationCode"), tooltip: `<a target="_blank" href="https://www.dimdi.de/dynamic/de/klassifikationen/icd/icd-o-3/icd03rev2html/">${$t("localizationCodeLong")}</a>` },
		{ data: 'ICDO_histologyCode', header: $t("histologyCode"), tooltip: `<a target="_blank" href="https://www.dimdi.de/dynamic/de/klassifikationen/icd/icd-o-3/icd03rev2html/">${$t("histologyCodeLong")}</a>` },
